...
python3 scripts/video_sample.py --model_path ema_0.9999_002000.pt --data_dir videos/ --num_samples 1 --batch_size 1 --cond_frames 0,1,14,15, $MODEL_FLAGS $DIFFUSION_FLAGS
